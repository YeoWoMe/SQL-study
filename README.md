...
| 날짜                 | 주요 내용                                                         |
|----------------------|------------------------------------------------------------------|
| 5/26 (토)         | 환경 구축 점검, SQL 입문 문법 복습 및 문제 풀이                  |
| 6/2 (화)  | SQL 핵심 문법 복습 및 문제 풀이, 해설                            |
| 6/6 (토)   | 실전 분석용 SQL 문법 복습 및 데이터 분석 프로젝트 논의           |
| 6/23 (화)   | 실전 분석용 SQL 문법 복습 및 데이터 분석 프로젝트 논의           |
| 6/27 (토)   | 실전 분석용 SQL 문법 복습 및 데이터 분석 프로젝트 논의           |
| 7/9 (목)   | 실전 분석용 SQL 문법 복습 및 데이터 분석 프로젝트 논의           |

대면 스터디에서는 개념 리뷰 후 문제(2문제 예상) 풀이 후 함께 해설하는 방식으로 진행할 예정
...
| 주차 | 강좌        | 주요 내용                         |
|------|------------|----------------------------------|
| 1주차 |1, 2강     | DB 입문 및 MySQL 환경 구축        |
| 2주차 | 3강        | SQL 입문 문법                     |
| 3주차 | 4강        | SQL 기본 문법                     |
| 4주차 | 5강        | JOIN 문법                         |
| 5주차 | 6강        | 다양한 SQL 함수                   |
| 6주차 | 7, 8강     | 활용 및 크롤링 후 데이터 처리     |
